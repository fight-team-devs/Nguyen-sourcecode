...
int main()
{
	...
	while (1)
	{
		...
		if (x == 0)
		{
			cout << "nam ban nha la nam nhuan" << endl;
			switch (thang)
			{
			...
			case 2: cout << "thang 2 nam " << nam << " co 29 ngay" << endl;break;
			}
		}
		else
		{
			cout << "nam ban nhap khong phai nam nhuan" << endl;
			switch (thang)
			{
			case 1: cout << "thang 1 nam " << nam << " co 31 ngay" << endl;break;
			case 3: cout << "thang 3 nam " << nam << " co 31 ngay" << endl;break;
			...
			case 9: cout << "thang 9 nam " << nam << " co 30 ngay" << endl;break;
			case 11: cout << "thang 11 nam " << nam << " co 30 ngay" << endl;break;
			case 2: cout << "thang 2 nam " << nam << " co 28 ngay" << endl;break;
			}
		}
	}
	system("pause");
